...
// In standard template Library we going to cover these topices
// container
// Iterator
// Algorithms
// Functors
...
for(int x:vec2)cout << "Removing vec2 first elem"  <<  x << endl;
    cout << endl;
  ...
  for(int z:arr2){cout << " " << "Array after removing of Elem"<<  z << endl;}
